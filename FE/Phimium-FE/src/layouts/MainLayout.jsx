...
export function MainLayout({ children }) {
  ...
  const isBuddyDashboard = location.pathname === ROUTES.buddy || location.pathname.includes('/buddy')
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-br from-emerald-50 via-white to-teal-50 text-slate-950">
      ...
      <div className="relative z-10">
        ...
        {/* Chỉ render Header nếu KHÔNG PHẢI là trang Buddy Dashboard */}
        {!isBuddyDashboard && (
        ...
        {/* Xóa class pt-[128px] nếu đang ở trang Buddy Dashboard để nội dung đẩy lên trên cùng */}
        <main className={`relative z-0 ${isBuddyDashboard ? '' : 'pt-[128px]'}`}>
          {children}
        </main>
